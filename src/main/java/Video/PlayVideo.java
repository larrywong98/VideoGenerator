...
//
//            double fps = (1.0 / 53) * 1000;
//            long millis_prev = System.currentTimeMillis();
//            int readBytes=0;
////            BufferedImage grayImage;
//            Mat mat1=new Mat(width,height,CV_8UC1, new Scalar(0,0,0));
//            while (readBytes!= -1) {
...
////                    Imgcodecs.imwrite("1.png",mat1);
////                    String result = tesseract.doOCR(ImageIO.read(new File("1.png")));
//                    String result = tesseract.doOCR(bufImage);
...
//                int diff=(int)(fps - (int)millis_spent);
//                if(diff==0) diff=1;
//                HighGui.waitKey(diff);  // for 30 fps
